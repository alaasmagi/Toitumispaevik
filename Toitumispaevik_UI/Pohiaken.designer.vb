...
Partial Class Pohiaken
    ...
    Private Sub InitializeComponent()
        ...
        Me.chrKoduPaneel.Titles.Add(Title9)
        '
        'lblKoduEesnimi
        '
        ...
        Title10.Name = "Title1"
        Title10.Text = "Kehakaalu graafik"
        Me.chrKaaluMuutumine.Titles.Add(Title10)
        '
        'GroupBox2
        '
        ...
        Me.chrYlevaade.Series.Add(Series15)
